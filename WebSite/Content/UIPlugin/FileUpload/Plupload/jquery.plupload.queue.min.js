(function (c) {
    ...
    function b(f, e) {
        ...
        '<div class="plupload_wrapper plupload_scroll">' +
            '<div id="' + f + '_container" class="plupload_container">' +
                '<div class="plupload_content">' +
                    '<ul id="' + f + '_filelist" class="plupload_filelist"></ul>' +
                    '<div class="plupload_buttons">' +
                                '<a href="#" class="plupload_button plupload_add">' + a("选择文件") + '</a>' +
                                '<a href="#" class="plupload_button plupload_start">' + a("开始上传") + '</a>' +
                    '</div>' +
                 '</div>' +
             '<div>' +
            ...
            this.each(function () {
                ...
                function g() {
                    ...
                    function (p, o) {
                        ...
                        m.append('<li id="' + o.id + '"><div class="plupload_file_name">' + o.name + '</div><div class="plupload_file_status">' + o.percent + '%</div><div class="plupload_file_size">' + plupload.formatSize(o.size) + '</div><div class="plupload_clearer">&nbsp;</div>' + l + "</li>");
                        h(o);
